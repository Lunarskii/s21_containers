...
template <typename value_type>
typename multiset<value_type>::size_type multiset<value_type>::count(const_reference key) {
    return tree.count(key);
}

template <typename value_type>
typename multiset<value_type>::iterator multiset<value_type>::find(const_reference key) {
...
template <typename value_type>
std::pair<typename multiset<value_type>::iterator, typename multiset<value_type>::iterator> multiset<value_type>::equal_range(const_reference key) {
    return { lower_bound(key), upper_bound(key) };
}

template <typename value_type>
typename multiset<value_type>::iterator multiset<value_type>::lower_bound(const_reference key) {
    return iterator(tree.lower_bound(key));
}

template <typename value_type>
typename multiset<value_type>::iterator multiset<value_type>::upper_bound(const_reference key) {
...
template <typename value_type>
typename multiset<value_type>::multiset& multiset<value_type>::operator=(multiset&& other) {
    clear();
...
template <typename value_type>
typename multiset<value_type>::multiset& multiset<value_type>::operator=(const multiset& other) {
    if (this != &other) {
        clear();
