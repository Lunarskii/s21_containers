...
TEST(METHOD_EQUAL_RANGE, MULTISET_EQUAL_RANGE_EXISTING_ELEMENT) {
    s21::multiset<int> M1 = {50, 25, 75, 10, 40, 5, 5, 15};
    std::multiset<int> M2 = {50, 25, 75, 10, 40, 5, 5, 15};
    std::pair<s21::multiset<int>::iterator, s21::multiset<int>::iterator> it_S1 = M1.equal_range(6);
    std::pair<std::multiset<int>::iterator, std::multiset<int>::iterator> it_S2 = M2.equal_range(6);
...
TEST(METHOD_EQUAL_RANGE, MULTISET_EQUAL_RANGE_NOT_EXISTING_ELEMENT) {
    s21::multiset<int> M1 = {50, 25, 75, 10, 40, 5, 5, 15};
    std::multiset<int> M2 = {50, 25, 75, 10, 40, 5, 5, 15};
    std::pair<s21::multiset<int>::iterator, s21::multiset<int>::iterator> it_S1 = M1.equal_range(100);
    std::pair<std::multiset<int>::iterator, std::multiset<int>::iterator> it_S2 = M2.equal_range(100);
...
TEST(SET, MULTISET_OPERATOR_EQUAL_COPY_NOT_EMPTY_MULTISET) {
    ...
    std::multiset<int> M4 = {50, 25, 75, 10, 40, 5, 5, 15, 35, 45, 80, 60, 70, 55, 90, 78};
    M1 = M2;
    M3 = M4;
    ASSERT_EQ(setsEqual(M1, M3), true);
    ASSERT_EQ(setsEqual(M2, M4), true);
