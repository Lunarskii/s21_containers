...
bool setsEqual(s21::set<int> S1, std::set<int> S2) {
    ...
    s21::set<int>::iterator it_S1 = S1.begin();
    std::set<int>::iterator it_S2 = S2.begin();
...
TEST(METHOD_ERASE, SET_ERASE_RIGHT_CHILD) {
    s21::set<int> S1 = {1, 2, 3};
    std::set<int> S2 = {1, 2, 3};
    s21::set<int>::iterator it_S1 = S1.begin();
    std::set<int>::iterator it_S2 = S2.begin();
...
TEST(METHOD_ERASE, SET_ERASE_LEFT_CHILD) {
    s21::set<int> S1 = {3, 1, 2};
    std::set<int> S2 = {3, 1, 2};
    s21::set<int>::iterator it_S1 = --S1.end();
    std::set<int>::iterator it_S2 = --S2.end();
    S1.erase(it_S1);
    S2.erase(it_S2);
    ASSERT_EQ(setsEqual(S1, S2), true);
}

TEST(METHOD_ERASE, SET_ERASE_NO_CHILD) {
    s21::set<int> S1 = {1, 2, 3};
    std::set<int> S2 = {1, 2, 3};
    s21::set<int>::iterator it_S1 = --S1.end();
    std::set<int>::iterator it_S2 = --S2.end();
...
TEST(METHOD_ERASE, SET_ERASE_TWO_CHILDREN) {
...
// TEST(METHOD_ERASE, SET_ERASE_NOT_EXISTING_ITERATOR) {
//     s21::set<int> S1 = {3, 1, 2, 4, 5};
//     std::set<int> S2 = {3, 1, 2, 4, 5};
//     s21::set<int>::iterator it_S1;
//     std::set<int>::iterator it_S2;
//     S1.erase(it_S1);
//     S2.erase(it_S2);
//     ASSERT_EQ(setsEqual(S1, S2), true);
// }
...
TEST(METHOD_FIND, SET_FIND_EXISTING_ELEMENT) {
    s21::set<int> S1 = {50, 25, 75, 10, 40, 5, 15, 35, 45, 80, 60, 70, 55, 90, 78};
    std::set<int> S2 = {50, 25, 75, 10, 40, 5, 15, 35, 45, 80, 60, 70, 55, 90, 78};
    s21::set<int>::iterator it_S1 = S1.find(75);
    std::set<int>::iterator it_S2 = S2.find(75);
    ASSERT_EQ(*it_S1, *it_S2);
}

// TEST(METHOD_FIND, SET_FIND_EXISTING_NOT_EXISTING_ELEMENT1) {
//     s21::set<int> S1 = {50, 25, 75, 10, 40, 5, 15, 35, 45, 80, 60, 70, 55, 90, 78};
//     std::set<int> S2 = {50, 25, 75, 10, 40, 5, 15, 35, 45, 80, 60, 70, 55, 90, 78};
//     s21::set<int>::iterator it_S1 = S1.find(43);
//     std::set<int>::iterator it_S2 = S2.find(43);
//     ASSERT_EQ(*it_S1, *it_S2);
// }

// TEST(METHOD_FIND, SET_FIND_EXISTING_NOT_EXISTING_ELEMENT2) {
//     s21::set<int> S1 = {50, 25, 75, 10, 40, 5, 15, 35, 45, 80, 60, 70, 55, 90, 78};
//     std::set<int> S2 = {50, 25, 75, 10, 40, 5, 15, 35, 45, 80, 60, 70, 55, 90, 78};
//     s21::set<int>::iterator it_S1 = S1.find(0);
//     std::set<int>::iterator it_S2 = S2.find(0);
//     ASSERT_EQ(*it_S1, *it_S2);
// }

// TEST(METHOD_FIND, SET_FIND_EXISTING_NOT_EXISTING_ELEMENT3) {
//     s21::set<int> S1 = {50, 25, 75, 10, 40, 5, 15, 35, 45, 80, 60, 70, 55, 90, 78};
//     std::set<int> S2 = {50, 25, 75, 10, 40, 5, 15, 35, 45, 80, 60, 70, 55, 90, 78};
//     s21::set<int>::iterator it_S1 = S1.find(100);
//     std::set<int>::iterator it_S2 = S2.find(100);
//     ASSERT_EQ(*it_S1, *it_S2);
// }
...
TEST(SET, SET_OPERATOR_EQUAL_COPY_NOT_EMPTY_LIST) {
    ...
    s21::set<int> S2 = {50, 25, 75, 10, 40, 5, 15, 35, 45, 80, 60, 70, 55, 90, 78};
    std::set<int> S3 = {50, 25, 75, 10};
    std::set<int> S4 = {50, 25, 75, 10, 40, 5, 15, 35, 45, 80, 60, 70, 55, 90, 78};
    S1 = S2;
    S3 = S4;
    ASSERT_EQ(setsEqual(S1, S3), true);
    ASSERT_EQ(setsEqual(S2, S4), true);
...
TEST(ITERATORS, SET_MINUS_MINUS_OPERATOR) {
    s21::set<int> S1 = {50, 25, 75, 10, 40, 5, 15, 35, 45, 80, 60, 70, 55, 90, 78};
    std::set<int> S2 = {50, 25, 75, 10, 40, 5, 15, 35, 45, 80, 60, 70, 55, 90, 78};
    s21::set<int>::iterator it_S1 = ++S1.begin();
    std::set<int>::iterator it_S2 = ++S2.begin();
